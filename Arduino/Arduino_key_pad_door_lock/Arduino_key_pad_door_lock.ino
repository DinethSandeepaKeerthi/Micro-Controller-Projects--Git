...
char* password ="1122"; //create a password
...
void loop(){
  ...
  if(whichKey == '#'      //define invalid keys
  ){
  ...
  if(whichKey == 'A'  ||  whichKey == 'B'  ||whichKey == 'C'  ||whichKey == 'D'      //define invalid keys
  ){
