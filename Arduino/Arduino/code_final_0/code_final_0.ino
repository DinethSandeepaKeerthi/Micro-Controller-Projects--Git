...
const char* ssid = "SLT-4G_1F9351";
const char* password = "2C8F26BF";
...
<head>
  ...
  <style>
    ...
    .indicator-frame {
      ...
      width: 40px; /* Adjust the frame width as needed */
      height: 40px; /* Adjust the frame height as needed */
    ...
    .indicator {
      width: 40px; /* Adjust the circle diameter as needed */
      height: 40px; /* Adjust the circle diameter as needed */
      border-radius: 50%;
      display: inline-block;
      background-color: white; /* Initially white */
      margin-right: 10px;
...
<body>
  ...
  <div class="content">
    <div class="card">
      ...
      <div class="indicator-frame">
        <div id="indicator2" class="indicator indicator-stop-on"></div>
      </div>
  ...
  <script>
    ...
    function updateIndicators() {
      ...
      if (document.getElementById('gpioState1').innerHTML === "HIGH") {
      ...
      if (document.getElementById('gpioState2').innerHTML === "HIGH") {
        document.getElementById('indicator2').classList.remove('indicator-off');
        document.getElementById('indicator2').classList.add('indicator-stop-on');
      } else {
        document.getElementById('indicator2').classList.remove('indicator-stop-on');
